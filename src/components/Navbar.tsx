...
const Navbar: React.FC = () => {
    ...
    useEffect(() => {
        ...
        Emitter.get().on("page-update", () => setVisible(true));
    }, []);
    ...
    return (
        <nav
            ...
            <div className="flex space-x-9 max-sm:space-x-4">
                <NavbarButton text={clientWidth > 768 ? siteName : "主页"} linkTo="/"/>
                <NavbarButton text="百宝箱" linkTo="/treasure-chest"/>
                <NavbarButton text="动态" linkTo="/dynamic"/>
